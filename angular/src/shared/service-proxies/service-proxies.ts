...
export class DeviceServiceProxy {
     ...
     * @return Success
     */
    createDevice(body: DeviceInputDto | undefined): Observable<void> {
...
@Injectable()
export class DeviceControlServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    createControl(body: CreateControlInputDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/DeviceControl/CreateControl";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateControl(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateControl(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateControl(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class DeviceUpdateInputDto implements IDeviceUpdateInputDto {
    ...
    static fromJS(data: any): DeviceUpdateInputDto {
        data = typeof data === 'object' ? data : {};
        let result = new DeviceUpdateInputDto();
        result.init(data);
        return result;
    }
...
export class CreateControlInputDto implements ICreateControlInputDto {
    deviceId: number;
    ...
    constructor(data?: ICreateControlInputDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.pinNumber = _data["pinNumber"];
            this.valueString = _data["valueString"];
            this.valueDigital = _data["valueDigital"];
            this.valueAnalog = _data["valueAnalog"];
            this.valueType = _data["valueType"];
            this.isAccessed = _data["isAccessed"];
        }
    }

    static fromJS(data: any): CreateControlInputDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateControlInputDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["isAccessed"] = this.isAccessed;
        return data; 
    }

    clone(): CreateControlInputDto {
        const json = this.toJSON();
        let result = new CreateControlInputDto();
        result.init(json);
        return result;
...
export interface ICreateControlInputDto {
    deviceId: number;
    pinNumber: string | undefined;
    valueString: string | undefined;
    valueDigital: boolean;
