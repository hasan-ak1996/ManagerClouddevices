...
using ManageCloudDevices.Models.TokenAuth;
...
{
    public abstract class ManageCloudDevicesWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ManageCloudDevicesWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ManageCloudDevicesWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ManageCloudDevicesDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ManageCloudDevicesDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ManageCloudDevicesDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ManageCloudDevicesDbContext, Task<T>> func)
        {
            T result;
